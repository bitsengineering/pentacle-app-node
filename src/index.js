...
var socket = net.connect({ port: 8333, host: "seed.bitcoinstats.com" }, function () {
    ...
    peer.once("ready", function () {
        ...
        //       /* ****** */
        //       // GET TRANSACTIONS
        peer.getTransactions(Buffer.from("0000000000000000002b0fcdc0bdedcc71fcce092633885628c3b50d43200002", "hex").reverse(), [
            Buffer.from("43fff6eecfb04aca9c7bcc525fcf80f8704f7b603bb26af834432229720af5ba"),
            // Buffer.from(
